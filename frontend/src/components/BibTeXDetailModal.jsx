...
const BibTeXDetailModal = ({ isOpen, onClose, citation, onSave }) => {
  ...
  if ((!isOpen && !isClosing) || !citation) return null;
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-lg shadow-xl w-11/12 max-w-3xl max-h-[80vh] overflow-hidden flex flex-col ${isClosing ? 'animate-scaleOut' : 'animate-scaleIn'}`}
